...
function AboutUs() {
  return (
    <div className=" py-24 sm:py-48" id="aboutus">
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        ...
        <ul
          role="list"
          className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2 ml-32"
        >
          {people.map((person) => (
            <li key={person.name}>
              <div className="flex items-center gap-x-6">
                ...
                <div>
                  ...
                  <div className="mt-3 flex gap-4 text-gray-400">
                    <a href="https://github.com/Abdessamadbda">
                      <svg
                        className="w-5 h-5 duration-150 hover:text-gray-500 duration-150"
                        fill="none"
                        viewBox="0 0 48 48"
                      >
                    ...
                    <a href="https://www.linkedin.com/in/abdessamad-elbadaoui">
                      <svg
